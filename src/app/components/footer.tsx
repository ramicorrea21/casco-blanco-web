export default function Footer(){
    return(
        <>
         <div className="mt-10 mb-5 separador flex flex-col md:text-start text-center md:flex-row justify-center md:space-x-6 lg:space-x-10 xl:space-x-20 2xl:space-x-32 ">
