    ...
    <div className="mt-8 ">
      <div className="w-full md:h-32 h-24 premium-button rounded-xl flex flex-row justify-between">
        <div className="pl-3 md:pl-5 pt-4 flex flex-col xl:pt-5">
          <h1 className="max-[300px]:text-sm text-xl md:text-2xl lg:text-3xl 2xl:text-4xl ">VIVIENDA FAMILIAR PREMIUM</h1>
          <p className="max-[300px]:text-xs mt-0 md:mt-3 text-sm lg:text-xl">A PARTIR DE $560USD EL M2</p>
        </div>
        <div>
