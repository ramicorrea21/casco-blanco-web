    ...
    return(
        ...
        <nav className="sticky top-0 z-50 bg-white py-2">
            <div className="flex justify-between mt-1 md:mt-1">
                ...
                priority
                />
                <div className="flex mt-1 mr-3 md:mt-2 md:mr-6 max-[385px]:mr-1">
                    <p className="mr-2 md:mr-4 md:text-2xl text-md max-[385px]:text-sm">
                        Informacion
                    </p>
                    <div className="flex">
                    <span className="md:text-2xl text-md max-[385px]:text-sm">Contacto</span>
